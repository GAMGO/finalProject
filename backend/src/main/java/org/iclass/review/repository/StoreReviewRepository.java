...
public interface StoreReviewRepository extends JpaRepository<StoreReview, Long> {
    ...
    @Query("SELECT r FROM StoreReview r JOIN FETCH r.store s WHERE s.idx = :storeIdx ORDER BY r.createdAt DESC")
    Page<StoreReview> findByStoreIdxWithStore(Long storeIdx, Pageable pageable);
